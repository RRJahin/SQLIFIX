...
public static Reservation queryReservation(Connection conn, BigInteger GuestID) throws SQLException {
    String sql = "Select a.Reservation_Id, a.GuestID, a.start, a.end, a.numberRooms, a.bookingDate, a.status, a.reservationType, a.price from Reservations a where a.GuestID = "+GuestID.toString();
