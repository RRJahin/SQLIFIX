...
public void save(ProjectDetails projectDetails) {
    try {
        ...
        statement.executeUpdate("insert into project_hrm values("+projectDetails.getName()+","+projectDetails.getEnddate()+","+projectDetails.getTechnology()+","+projectDetails.getClients()+","+projectDetails.getId()+","+projectDetails.getTeamsize()+")");
