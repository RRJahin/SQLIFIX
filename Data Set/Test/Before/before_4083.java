class Dummy {
    public void update(TaskBean _taskToUpdate, long _transactionId) throws DBBeanException {
        ...
        try {
            ...
            String SQL_UPDATE = "UPDATE " + TASKS + " SET " + TASK_STATUS + " ='" + _taskToUpdate.getStatus() + "', "
                    + TASK_REQUEST_STATUS + " ='" + _taskToUpdate.getRequestStatus() + "', " + TASK_RESPONSE + " ='"
                    + _taskToUpdate.getResponse() + "', " + TASK_RESPONSE_TYPE + " ='" + _taskToUpdate.getResponseType()
                    + "', " + TASK_MODIFICATION + " = NOW(), " + TASK_UPDATED + " ='" + updated + "' " + " WHERE "
                    + TASK_ID + " ='" + _taskToUpdate.getId() + "'";
