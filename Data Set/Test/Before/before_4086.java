class Dummy {
    public void setTaskAsReaded(TaskBean _taskToUpdate, long _transactionId) throws DBBeanException {
        ...
        try {
            ...
            String SQL_UPDATE = "UPDATE " + TASKS + " SET " + TASK_UPDATED + " ='" + updated + "' " + " WHERE "
