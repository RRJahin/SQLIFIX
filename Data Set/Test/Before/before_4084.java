class Dummy {
    public void update(TaskBean _taskToUpdate, long _transactionId) throws DBBeanException {
        ...
        try {
            ...
            String SQL_UPDATE = "UPDATE " + TASKS + " SET " + TASK_NAME + " ='" + _taskToUpdate.getName() + "', "
                    + TASK_STATUS + " ='" + _taskToUpdate.getStatus() + "', " + TASK_REQUEST_STATUS + " ='"
                    + _taskToUpdate.getRequestStatus() + "', " + TASK_RESPONSE + " ='" + _taskToUpdate.getResponse()
